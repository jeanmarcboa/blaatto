...
const CartSidebarModal = () => {
  ...
  useEffect(() => {
    console.log("first", useNotificationModalContext());
  ...
  return (
    <div
      className={`fixed top-0 left-0 z-99999 overflow-y-auto no-scrollbar w-full h-screen bg-dark/70 ease-linear duration-300 ${
        isNotificationModalOpen ? "translate-x-0" : "translate-x-full"
      }`}
    >
          ...
          <div className="border-t border-gray-3 bg-white pt-5 pb-4 sm:pb-7.5 lg:pb-11 mt-7.5 sticky bottom-0">
            ...
            <div className="flex items-center gap-4">
              <Link
                onClick={() => closeNotificationModal()}
                href="/cart"
                className="w-full flex justify-center font-medium text-white bg-green py-[13px] px-6 rounded-md ease-out duration-200 hover:bg-green-dark"
              >
                Voir le panier
              </Link>
