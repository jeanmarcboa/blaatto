      ...
      <div className="relative overflow-hidden rounded-lg bg-[#F6F7FB] min-h-[403px]">
        <div className="text-center px-4 py-7.5">
          ...
          <div className="flex flex-row justify-center gap-2 mt-2">
            <Link href={"/boutique/" + item?.shop?.id}>
              <div className="max-w-[30px] w-full bg-[#F2F3F8] h-[30px] rounded-full flex items-center justify-center mb-4">
                <Image
        ...
        <div className="absolute right-0 bottom-0 translate-x-full u-w-full flex flex-col gap-2 p-5.5 ease-linear duration-300 group-hover:translate-x-0">
          <button
            ...
            id="bestOne"
            className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 text-dark bg-white hover:text-white hover:bg-green"
          >
            <svg
