...
const Cart = () => {
  ...
  return (
    <>
      ...
      <section>
        <Breadcrumb title={"Mon Panier"} pages={["Cart"]} />
      </section>
      ...
      {cartItems.length > 0 ? (
          ...
          <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            ...
            <div className="flex flex-wrap items-center bg-white mb-4 rounded-[10px] shadow-1 gap-5 xl:gap-12.5 py-4.5 px-4 sm:px-6">
              {groupedCart?.map((item, key) => (
                ...
                >
                  {item?.shop?.label} ({item?.items.length})
                </button>
              ))}
            </div>
            ...
            <div className="bg-white rounded-[10px] border border-gray-4 dark:border-gray-800 overflow-hidden">
              <div className="w-full overflow-x-auto">
                <div className="min-w-[1170px]">
                  {/* <!-- table header --> */}
                  <div className="flex items-center bg-gray-1 py-5.5 px-7.5">
        ...
        <>
          <div className="text-center mt-8">
            ...
            <p className="pb-6">Votre panier est vide !</p>
