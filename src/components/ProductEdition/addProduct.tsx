...
export const AddProduct = () => {
  ...
  const handleSubmit = (e: any) => {
    ...
    let tmpData = {
      productDesignationId: productName,
    ...
    product
      .createProduct(tmpData, userInfo?.access_token)
      .then((response) => {
                ...
                <div className="p-6 description">
                  <div>
                    ...
                    <AutoComplete
                      ...
                      style={{ padding: 0 }}
                      onChange={(e) => {
                        let value = labelsList.find(
                          (item: any) => item.label === e
                        );
              ...
              <div className="rounded-xl bg-white shadow-1 border-[1px] border-solid border-gray-4 mt-4">
                ...
                <div className="p-6 flex flex-row flex-wrap gap-4">
                  <div className="md:w-[50%]">
                    <label className="block text-sm font-medium text-gray-700">
                      Prix <span className="text-red">*</span>
                    </label>
                    <input
                      type="number"
                      value={price}
            ...
            <div className="xl:max-w-[25%] w-full">
              ...
              <div className="rounded-xl bg-white shadow-1 border-[1px] border-solid border-gray-4 mt-4">
                ...
                <div className="p-6">
                  <div className="mt-4">
                    <label className="block text-sm font-medium text-gray-700">
                      Ajouter une Catégorie <span className="text-red">*</span>
                    </label>
                    <select
