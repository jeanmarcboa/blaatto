              ...
              <div className="flex items-center gap-5">
                ...
                >
                  <span className="inline-block relative">
                    ...
                    <span className="flex items-center justify-center font-medium text-2xs absolute -right-2 -top-2.5 bg-green w-4.5 h-4.5 rounded-full text-white">
                      {product.length}
                    </span>
                  </span>
            ...
            <div className="hidden xl:block">
              <ul className="flex items-center gap-5.5">
                {/* <li className="py-4">
                  <a
                    href="#"
                    className="flex items-center gap-1.5 font-medium text-custom-sm text-dark hover:text-green"
                  >
                    <svg
                      className="fill-current"
                      width="16"
