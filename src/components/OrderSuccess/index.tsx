...
const OrderSuccess = () => {
  return (
    <>
      <Breadcrumb title={"Commande confirmée"} pages={["OrderSuccess"]} />
          ...
          <div className="bg-white rounded-xl shadow-1 px-4 py-10 sm:py-15 lg:py-20 xl:py-25">
            <div className="text-center">
              ...
              <p className="max-w-[491px] w-full mx-auto mb-7.5">
                Merci beaucoup pour votre commande. Nous vérifions fréquemment
                nos e-mails et ferons de notre mieux pour répondre à votre
                demande.
              </p>
