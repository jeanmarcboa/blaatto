  ...
  return (
    <div className="flex items-center border-t border-gray-3 py-5 px-10">
      ...
      <div className="min-w-[265px]">
        {item.stock > 0 && <p className="text-dark">En stock({item.stock}) </p>}
        {item.stock === 0 && (
      ...
      <div className="min-w-[150px] flex justify-end">
        <button
          ...
          className="inline-flex text-dark hover:text-white bg-gray-1 border border-gray-3 py-2.5 px-6 rounded-md ease-out duration-200 hover:bg-green hover:border-gray-3"
        >
          Ajouter au panier
        </button>
      </div>
